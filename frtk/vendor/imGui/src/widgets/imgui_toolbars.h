...
//         https://github.com/Flix01/imgui/tree/imgui_with_addons/addons/imguitoolbar
...
namespace ImGui {
    ...
    public:
        struct Button {
            ...
            bool isToggleButton;
            mutable bool isDown;
            inline Button(const char* _tooltip, unsigned long long _user_texture_id, const ImVec2& _uv0, const ImVec2& _uv1, const ImVec2& _size = ImVec2(32, 32), bool _isToggleButton = false, bool _isDown = false, const ImVec4& _tint_col = ImVec4(1, 1, 1, 1))
        ...
        int render(bool allowdHoveringWhileMouseDragging = false, int limitNumberOfToolButtonsToDisplay = -1) const {
            ...
            if (dontSkip) {
                ...
                for (int i = 0; i < numberToolbuttons; i++) {
                    ...
                    ImGui::PushID(i);
                    if (ImGui::ImageButton("",tb.user_texture_id, tbsz, tb.uv0, tb.uv1, bg_col, tint_col)) {
